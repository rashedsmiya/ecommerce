        ...
        <>
          ...
          <section className="section-1">
                <Swiper
                  ...
                  >               
                    <SwiperSlide>
                        <div className="content" style={{ backgroundImage: `url(${SliderOneImg})`, height: '750px', width: '100%' }}>                        
                        </div>                   
                    </SwiperSlide>
                    <SwiperSlide>
                        <div className="content" style={{ backgroundImage: `url(${SliderTwoImg})`, height: '750px', width: '100%' }}>                        
                        </div>
                    </SwiperSlide>                
                </Swiper>
          </section>
                ...
                <div className="row spotlight py-5">
                    <div className="col-md-4">
                      <div className="d-flex justify-content-center">
                       ...
                       <h3 className="ps-3">Free Delivary</h3>
                      </div>
                    </div>  
                    <div className="col-md-4">
                      <div className="d-flex justify-content-center">
